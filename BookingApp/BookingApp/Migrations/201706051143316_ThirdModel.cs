    ...
    public partial class ThirdModel : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.Places", t => t.PlaceId, cascadeDelete: true) //bilo false
                .Index(t => t.PlaceId)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Accommodations", t => t.AccommodationId, cascadeDelete: true) //treba false
                .ForeignKey("dbo.AppUsers", t => t.AppUserId, cascadeDelete: true) //treba false
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AppUsers", t => t.AppUserId, cascadeDelete: true) //treba false
                .ForeignKey("dbo.Rooms", t => t.RoomId, cascadeDelete: true) //treba false
                .Index(t => t.RoomId)
                .Index(t => t.AppUserId);
